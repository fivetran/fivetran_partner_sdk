...
When you are confident your connector is working we will deploy it into production marked as 'in dev' - during this phase it is hidden to mutual customers however you will be able to setup and run final end-2-end tests. This is also when its important to submit and finalize your documentation.
When you are confortable all functionality is working correctly you can request to promote your connector to Private Preview.
